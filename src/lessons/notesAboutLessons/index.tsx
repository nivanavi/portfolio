...
// TODO SHADOWS тени. что бы это работало tree js перед рендером встает на место источника света тем самым понимая что "видит" этот источник и делаеи карту теней
